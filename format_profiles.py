...
def parse_one_aggregate_profile(csv_file=None, example=False, nrows=None, skiprows=3, gpu_activities_only: bool = False):
    """
...
def parse_all_profiles(
    folder: Union[Path, str], save_filename=None, gpu=0, verbose=True
) -> None:
    """
